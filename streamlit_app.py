...
geo_client_id = "buzzqnu77m"
geo_client_secret = "QkOrNDd4v57qIR2WKrE1gNO7WKKYeiXUMtjjfTAN"

# 네이버 Static API 설정
static_client_id = "xbajg8w92p"
static_client_secret = "MPSE5rkfxFRJT98AgbzRoidsGBu3xjT1h93tKSac"
...
# 네이버 지도 이미지를 생성하는 함수 (Static API 사용)
def create_naver_map_url(start_coord, end_coord):
    ...
    headers = {
        "X-NCP-APIGW-API-KEY-ID": static_client_id,
        "X-NCP-APIGW-API-KEY": static_client_secret
    }
...
# Streamlit 앱 UI
st.title("출발지와 도착지의 거리 및 지도 표시 1528")
